...
namespace csFTPStarter
{
    public partial class DummyWindow : Form
    {
        ...
        public DummyWindow(MainForm frm1)
        {
            InitializeComponent();
            mainForm = frm1;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DummyWindow_FormClosing);
        }
        ...
        private void SaveWindowPosition()
        {
            ...
            {
                mainForm.txtPosX6.Text = rvX.ToString();
                mainForm.txtPosY6.Text = rvY.ToString();
            }
        }
        ...
        {
            /*
            DialogResult rv = MessageBox.Show("Save Window Position?", "Table " + winNum.ToString(), MessageBoxButtons.YesNo);
        ...
        private void DummyWindow_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (bVerify)
                lblTableNumber_Click(sender, e);
        }
