...
public class FileFunctions
{
    ...
    public static string[] GetCategories(string inifile)
    {
        ...
        GetPrivateProfileString(null, null, "", returnString, 1024, inifile);

        return returnString.Split(new char[] { '\0' }, StringSplitOptions.RemoveEmptyEntries);
    }

    public static string[] GetKeys(string category, string inifile)
    {
        string returnString = new string('\0', 1024);
        GetPrivateProfileString(category, null, "", returnString, 1024, inifile);

        return returnString.Split(new char[] { '\0' }, StringSplitOptions.RemoveEmptyEntries);
    }

    public static string[] GetValues(string category, string key, string inifile)
    {
        string returnString = new string('\0', 1024);
        GetPrivateProfileString(category, key, "", returnString, 1024, inifile);
