...
{
    public partial class DummyWindowIgnition : Form
    {
        public int rvX=0;
        public int rvY=0;
        ...
        public DummyWindowIgnition(MainForm frm1)
        {
            InitializeComponent();
            mainForm = frm1;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DummyWindowIgnition_FormClosing);
        }
        ...
        private void DummyWindowIgnition_Load(object sender, EventArgs e)
        {
        ...
        private void DummyWindowIgnition_FormClosing(object sender, FormClosingEventArgs e)
        {
